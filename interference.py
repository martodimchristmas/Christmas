...
from colormaps import redblue, redwhiteblue, inversegray
...
# Calculate the position of the centers of the circular source points
x1 = side/2 + separation/2
y1 = side/2
x2 = side/2 - separation/2
y2 = side/2

# Make an array to store the highlights
